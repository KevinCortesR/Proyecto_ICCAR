...
plt.savefig("Malla.pdf", bbox_inches='tight')
plt.savefig("Malla.eps", format = 'eps', bbox_inches='tight')
...
CS = plt.contour(xcr, ycr, z, 30, colors = 'k', linewidths = 1, linestyles = '--')
plt.clabel(CS, inline = 1, fontsize = 9)
plt.title(f"Distribución de temperatura en la placa en °C", y = 1.01)
plt.xlabel('Longitud [m]')
plt.ylabel('Longitud [m]')
plt.savefig("Dist_T.pdf")
plt.savefig("Dist_T.eps", format = 'eps')
...
plt.savefig("Residuales.eps", format = 'eps')
